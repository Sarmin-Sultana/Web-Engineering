...
<body>
<div class="container">
 <form id="regForm"   action="connect.php" method="POST" enctype="multipart/form-data">
 <h1>বাংলাদেশ উন্মুক্ত বিশ্ববিদ্যালয়</h1>
    <p ><b> <strong>গাজীপুর-১৭০৫</strong></b></p>
      <hr>
       <h3 >অধ্যাপক / সহযোগী অধ্যাপক / সহকারী অধ্যাপক / প্রভাষক পদের জন্য আবেদনপত্র</h3>
  ...
  <table text align:left>
    <tr>
   <td>   <label for="sname">স্কুলের নামঃ</label></td>
     <td> 
  
     <select id="sname" name="sname"   style="width: 700px;height: 40px;">
        <option value="">Select</option>
         <option value="Open School">Open School</option>
         <option value="School of Agriculture &amp; Rural Development (SARD)">School of Agriculture &amp; Rural Development (SARD)</option>
         <option value="School of Business (SoB)">School of Business (SoB)</option>
         <option value="School of Education (SoE)">School of Education (SoE)</option>
         <option value="School of Social Science, Humanities &amp; Languages (SSHL)">School of Social Science, Humanities &amp; Languages (SSHL)</option>
         <option value="School of Science &amp; Technology (SST)">School of Science &amp; Technology (SST)</option>
     </select>
...
style="width: 170px;height: 40px;"> <option value=""> Select </option><option value="1st Class">1st Class</option><option value="2nd Class">2nd Class</option><option value="3rd Class">3rd Class</option><option class="editable" value="CGPA(Out of 4)"  >CGPA(Out of 4) </option><option value="CGPA(Out of 5)">CGPA(Out of 5)</option><option value="Others">Others</option>
  ...
  $(document).ready(function () {
      ...
      <li> <label for="b">  লিখিত বা একাধিক গবেষণামূলক রচনার তালিকা এবং যে পত্র-পত্রিকায় রচনা মুদ্রিত হয়েছে তার নাম উল্লেখঃ </label><br>
       <br>
       ...
       <fieldset id="fieldset">
        <legend id="legend" style="color: black";>    Research Paper</legend><br>
       <table>
           <tr>
     <td><label for="Author Name">Author Name </label></td>
      <td><input type="text" id="Author_Name" name="Author_Name"  placeholder="Papper 1"  style="width: 200px;height: 15px;"></td> 
          <td><input type="text" id="Author2" name="Author2" placeholder="Papper 2" style="width: 200px;height: 15px;"></td> 
          <td><input type="text" id="Author3" name="Author3" placeholder="Papper 3"  style="width: 200px;height: 15px;"></td> 
           </tr>
            <tr>
     <td><label for="Research Title">Research Title </label></td>
      <td><input type="text" id="Research_Title" name="Research_Title"  style="width: 200px;height: 15px;"></td>
          <td><input type="text" id="Title2" name="Title2"  style="width: 200px;height: 15px;"></td> 
          <td><input type="text" id="Title3" name="Title3"  style="width: 200px;height: 15px;"></td>
           </tr>
           <tr>
     <td><label for="Publishers Name">Publisher's Name </label></td>
      <td><input type="text" id="Publishers_Name" name="Publishers_Name"  style="width: 200px;height: 15px;"></td>
          <td><input type="text" id="Publisher2" name="Publisher2"  style="width: 200px;height: 15px;"></td> 
          <td><input type="text" id="Publisher3" name="Publisher3"  style="width: 200px;height: 15px;"></td> 
        
           </tr>
           <tr>
      <td><label for="Publishers Date"> Publish Date</label></td>
      <td><input type="date" id="Publishers_Date" name="Publishers_Date"  style="width: 200px;height: 40px;"></td>
          <td><input type="date" id="pdate2" name="pdate2"  style="width: 200px;height: 40px;"></td> 
          <td><input type="date" id="pdate3" name="pdate3"  style="width: 200px;height: 40px;"></td>
           </tr>
           <tr>
             <td><label for="file">Attach File </label></td>
      ...
      <div  class="row" style="margin-top:5px; float: right; ">
						<div class="col-md-4"><button id="delete" type="button"   >Remove</button></div>
					</div>
       <br><br>
       <div class="row" style="margin-top:5px; ">
						<div class="col-md-4"><button id="add_more" type="button" >Add More Paper!</button></div>
					</div>
...
$("#add_more").click(function () {
            var newElement = $('<div id="childdiv"/>').html($("#paper").html());
            newElement.addClass('input');
            $("#paper").after(newElement);
            childId++;
    });
    $("#delete").click(function () {
      ...
      <li> <label for="">শিক্ষাদান কর্মে অভিজ্ঞতাঃ</label>
      <br>
       ...
       <label for="f">      (গ) যে সব ক্লাসে ও বিষয়ে শিক্ষকতা হয়েছে তার বিবরনঃ</label><br>
      ...
      <li> <label for="j"> কোন আবাসিক বিশ্ববিদ্যালয়ের অভিজ্ঞ ও ছাত্রদের যৌথ গঠনমূলক কার্যকলাপ উন্নয়নে সামর্থ্যঃ</label><br>
      <input type="text" id="extracurricular" name="extracurricular"  style="width: 800px;height: 25px;"><br><br><br></li>
      
      <li> <label for="k">  ছকপত্রে বর্ণিত নাই এমন অতিরিক্ত তথ্য লিপিবদ্ধ করিবার জন্যঃ</label><br>
