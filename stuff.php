...
<div class="container">
  ...
  <form id="regForm"   action="connectstuff.php" method="POST" enctype="multipart/form-data">
 <h1>বাংলাদেশ উন্মুক্ত বিশ্ববিদ্যালয়</h1>
    <p ><b> <strong>গাজীপুর-১৭০৫</strong></b></p>
       <hr>
       <h3> কর্মচারী পদের জন্য আবেদনপত্র</h3>
  ...
  <table text align:left>
     ...
     <td>  <select id="pname" name="pname"  style="width: 700px;height: 40px;">
            ...
            <option value="">UDA</option>
            <option value="LDA">LDA</option>
            <option value="Night Guard">Night Guard</option>
            <option value="Office Assistsnt">Office Assistant</option>
            <option value="Classifier">Classifier </option>
             <option value="Office Assistsnt cum Computer Typist">Office Assistsnt cum Computer Typist </option>
              <option value="Helper for Carpenter"> Helper for Carpenter</option>
...
style="width: 170px;height: 40px;"> <option value=""> Select </option><option value="1st Class">1st Class</option><option value="2nd Class">2nd Class</option><option value="3rd Class">3rd Class</option><option class="editable" value="CGPA(Out of 4)"  >CGPA(Out of 4) </option><option value="CGPA(Out of 5)">CGPA(Out of 5)</option><option value="Others">Others</option>
  ...
  $(document).ready(function () {
      ...
      <input type="text" id="suspention_details" name="	suspention_details"  style="width: 800px;height: 25px;"><br><br><br></li>
        ...
        <li> <label for="j"> প্রশিক্ষন (যদি থাকে ) </label><br>
     <textarea id="trainning_details" name="trainning_details"   style="height:70px; width: 800px"></textarea><br><br> <br></li> 
      
     <li> <label for="k"> অন্যান্য তথ্য (প্রযোজ্য ক্ষেত্রে)</label><br>
