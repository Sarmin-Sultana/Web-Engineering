...
if(mysqli_connect_error()){
        ...
        $sql = "SELECT * FROM o_school_info ,o_personal_info ,o_bank_info ,o_present_address ,o_extra_edu_info , o_honours_info ,o_hsc_info ,o_image_sign_date ,o_masters_info ,o_other_info ,o_parmanent_add ,o_ssc_info WHERE ( o_school_info.id = o_personal_info.id AND o_school_info.id= o_bank_info.id AND o_school_info.id= o_present_address.id AND o_school_info.id=o_extra_edu_info.id AND o_school_info.id=o_honours_info.id AND o_school_info.id=o_hsc_info.id AND o_school_info.id=o_image_sign_date.id AND o_school_info.id=o_masters_info.id AND o_school_info.id=o_other_info.id AND o_school_info.id=o_parmanent_add.id AND  o_school_info.id=o_ssc_info.id AND o_school_info.designation='Chairman')";
   ...
   $sql = "SELECT * FROM o_school_info ,o_personal_info ,o_bank_info ,o_present_address ,o_extra_edu_info , o_honours_info ,o_hsc_info ,o_image_sign_date ,o_masters_info ,o_other_info ,o_parmanent_add ,o_ssc_info WHERE ( o_school_info.id = o_personal_info.id AND o_school_info.id= o_bank_info.id AND o_school_info.id= o_present_address.id AND o_school_info.id=o_extra_edu_info.id AND o_school_info.id=o_honours_info.id AND o_school_info.id=o_hsc_info.id AND o_school_info.id=o_image_sign_date.id AND o_school_info.id=o_masters_info.id AND o_school_info.id=o_other_info.id AND o_school_info.id=o_parmanent_add.id AND  o_school_info.id=o_ssc_info.id AND o_school_info.designation='Vice Chairman')";
        ...
        $total20 = mysqli_num_rows($data);
          ...
          $sql ="SELECT * FROM o_school_info ,o_personal_info ,o_bank_info ,o_present_address ,o_extra_edu_info , o_honours_info ,o_hsc_info ,o_image_sign_date ,o_masters_info ,o_other_info ,o_parmanent_add ,o_ssc_info WHERE ( o_school_info.id = o_personal_info.id AND o_school_info.id= o_bank_info.id AND o_school_info.id= o_present_address.id AND o_school_info.id=o_extra_edu_info.id AND o_school_info.id=o_honours_info.id AND o_school_info.id=o_hsc_info.id AND o_school_info.id=o_image_sign_date.id AND o_school_info.id=o_masters_info.id AND o_school_info.id=o_other_info.id AND o_school_info.id=o_parmanent_add.id AND  o_school_info.id=o_ssc_info.id AND o_school_info.designation='Assistant Hardware Maintenance Engineer')";
        $data = mysqli_query($conn, $sql);  
